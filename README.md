Если у Вас стоит Windows и Вы решили использовать Meteor.JS - поздравляю, Вам необходимо установить нормальную операционную систему

На моей машинке уже установлен MongoDB, Node.js (установка node.js), Meteor, Meteorite
